...
class jobapp(tk.Tk):
    ...
    def __init__(self, *arg, **kwarg):
        ...
        accept_applicant_button = ttk.Button(self.employer,
    ...
    def finish_s(self, job_t, location, email, phone):
        if '@' not in email:
            invalid_email_s_label = ttk.Label(self.student_setup,
                                              text='Please enter a valid email', width=30)
    ...
    def user_check_s(self, user, password, act_type):
        ...
        if len(user) == 0:
            invalid_username_signup = ttk.Label(self.login,
                                                text='Username should be your name', width=42)
                        ...
                        with open('CurrentLogged.txt') as k:
                            ...
                            with open(first[:-2] + '2.txt') as j:
                                ...
                                if 'RefNo' in z.read():
                                    ...
                                    reference_number_r_label = ttk.Label(self.reference, anchor='center',
                                                                         text='Reference Number: ' +
                                                                         topline.strip('RefNo'),
                                                                         font='Helvetica 10 underline')
                    ...
                    if act_type == 1:
                        ...
                        for i in range(line_count):
                            ...
                            if first[:-1] in referencelook.read():
                                ...
                                student_r_label.grid(row=10 + i,
                                                     column=4)
                                comment_r_label = ttk.Button(self.reference, text='Comment',
                                                             command=lambda stud=stud:
                                                             self.which_stud(stud), width=15)
                                comment_r_label.grid(row=10 + i,
                                                     column=6)
                        ...
                        with open('Logged.txt') as h:
                            ...
                            with open(first[:-1] + '3.txt') as j:
                                top = j.read()
                                topline = top.split('\n', 0)[0]
                                reference_number_e_label = ttk.Label(self.employer,
                                                                     anchor='center',
                                                                     text='Reference Number: ' +
                                                                     topline.strip('RefNo'),
                                                                     font='Helvetica 12 underline',
                                                                     width=40)
                                reference_number_e_label.grid(row=1,
                                                              column=2)
                            try:
                                f = open('Employers.txt', 'x')
                            except FileExistsError:
        ...
        with open('Logged.txt') as h:
            ...
            if len(student) == 0:
                false_applicant_e_label = ttk.Label(self.employer,
                                                    text='Please enter a student', width=25)
                ...
                false_applicant_e_label = ttk.Label(self.employer,
                                                    text='Please enter a real applicant',
                                                    width=25)
                false_applicant_e_label.grid(row=9, column=2,
                                             columnspan=2)
        ...
        if len(user) == 0:
            ...
            if user in open_u.read():
                ...
                if len(refno) == 0:
                    ...
                    invalid_user_lr_label = Label(self.link_ref,
                                                  text='That User does not exist', width=42)
                    invalid_user_lr_label.grid(row=24, column=3,
                                               columnspan=6, sticky='W')
            else:
                invalid_user_lr_label = Label(self.link_ref,
            ...
            if user in open_u.read():
                ...
                if len(refno) == 0:
                    applied_s_label = ttk.Label(self.student,
                                                text='Please enter the company number',
                                                width=30)
                    applied_s_label.grid(row=15, column=4)
                elif refno in open_e.read():
                    if first in open(user + '.txt', 'r').read():
                        applied_s_label = ttk.Label(self.student,
                                                    text= 'You have applied already!',
                                                    width=30)
                        applied_s_label.grid(row=15, column=4)
                    else:
                        try:
                        ...
                        contact_s_label = ttk.Label(self.student,
                                                    text='You will be contacted later',
                                                    width=30)
